...
include("${CMAKE_CURRENT_LIST_DIR}/../includes/iar_vwsrl78_includes.cmake")
...
# set(CFLAGS_Second_Part --core=${MCU} --code_model=far --data_model=near --near_const_location ROM0 -Om --no_tbaa -e -l)
set(CFLAGS_Second_Part --core=${MICROCONTROLLER} --code_model=far --data_model=near --near_const_location ROM0 -Om --no_tbaa -e -l ${CMAKE_LST_OUTPUT_DIRECTORY})
...
set(DEFAULT_LINK_FLAGS "-eHWDIV_8_8_8=?UC_DIV_L01 -eHWMOD_8_8_8=?UC_MOD_L01 -eHWSDIV_8_8_8=?SC_DIV_L01 -eHWSMOD_8_8_8=?SC_MOD_L01 -eHWSDIV_16_16_16=?SI_DIV_L02 -eHWSMOD_16_16_16=?SI_MOD_L02 -eHWSDIV_32_32_32=?SL_DIV_L03 -eHWSMOD_32_32_32=?SL_MOD_L03")
set(DEFAULT_LINK_FLAGS_DEBUG "${DEFAULT_LINK_FLAGS} -cRL78 ${checksum} -HFFFF -l ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${PROJECT_NAME}.map -xeimns -rt -Oieee695,lbm=${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${PROJECT_NAME}.695 -Oelf,spc=${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${PROJECT_NAME}.elf -z -Omotorola-s28=${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${PROJECT_NAME}.s28")
...
set(EXEC_OUTPUT "-Omotorola-s28=\"${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/${PROJECT_NAME}.s28\"")
