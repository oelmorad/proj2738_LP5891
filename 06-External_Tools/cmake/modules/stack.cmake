...
set(CHILD_FILES         "")
set(SRC_DIR "01-SRC")
set(TEST_DIR "02-Validation/01-Unitary/01-VectorCast/01-VCAST_Manage")
Scan_STACK(${PROJECT_DIR})
...
list(APPEND ALL_INCLUDE_DIRS ${COMPILER_INCLUDES})
...
if(${CMAKE_CURRENT_SOURCE_DIR} STREQUAL ${CMAKE_SOURCE_DIR})
    ...
    target_include_directories(${PROJECT_NAME} PUBLIC ${ALL_INCLUDE_DIRS} ${compiler_include_directories})
